    ...
    for c in candidates:
        ...
        items.append({
            ...
            "provider": {
                "id": provider.id,
                "name": provider.name,
                "short_intro": provider.short_intro,
                "avatar_url": provider.avatar_url,
                "rating_avg": provider.rating_avg,
                "orders_count": provider.orders_count,
                "response_sla_minutes": provider.response_sla_minutes,
                "regions": provider.regions,
                "practice_areas": provider.practice_areas,
                "featured_tags": provider.featured_tags,
                "hourly_rate_range": provider.hourly_rate_range,
            },
            "product": {
                "id": product.id,
                "name": product.name,
