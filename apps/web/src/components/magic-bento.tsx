...
const cardData = [
  {
    color: '#120F17',
    title: '商标查重',
    description: '智能检索近似商标，评估注册风险',
    label: 'Trademark'
  },
  {
    color: '#120F17',
    title: 'IP 诊断',
    description: '全面分析知识产权保护状况',
    label: 'Diagnosis'
  },
  {
    color: '#120F17',
    title: '侵权监控',
    description: '实时追踪潜在侵权行为',
    label: 'Monitor'
  },
  {
    color: '#120F17',
    title: '申请书生成',
    description: '一键生成规范申请文档',
    label: 'Document'
  },
  {
    color: '#120F17',
    title: '专利评估',
    description: '评估专利可行性与价值',
    label: 'Patent'
  },
  {
    color: '#120F17',
    title: '资产台账',
    description: '知识产权资产统一管理',
    label: 'Ledger'
  }
];
...
type MagicBentoProps = {
  ...
  clickEffect?: boolean;
  enableMagnetism?: boolean;
  onCardClick?: (index: number, label: string) => void;
};
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          const cardProps = {
            ...
            onClick: () => onCardClick?.(index, card.label)
          };
